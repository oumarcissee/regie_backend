# Generated by Django 4.2.5 on 2024-01-03 21:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_id', app.utils.utils.CustomPrimaryKeyField(max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='Articles/%Y/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider_order', to='app.provider')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='providers', to='app.provider')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('empty', 'Empty'), ('admin', 'Admin'), ('manager_a', 'Manager_a'), ('manager_b', 'Manager_b'), ('kepper_a', 'Kepper_a'), ('kepper_b', 'Kepper_b')], default='empty', max_length=20)),
